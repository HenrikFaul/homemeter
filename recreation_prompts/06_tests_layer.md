# 06_tests_layer — generátor prompt
...
Cél: Simple Node assert test verifying database connection success via db.exec check or basic API response structure validation without Jest dependencies.
